...
urlpatterns = [
 ...
 path('meena@kh8656/6302a139-d03a-11ef-8903-5d0b6fd2483d/<str:username>',views.vlogapi,name="api"),
 path('meena@kh8656/6302a139-d03a-11ef-8903-5d0b6fd2483d/<str:quary>/<int:number>/<str:user>',views.api,name="api"),
